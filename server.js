...
// Tournois autorisés
var ALLOWED_TOURNAMENTS = {
  // Grandes ligues européennes
  17: 'Premier League', 18: 'Championship', 19: 'League One', 20: 'League Two',
  8: 'LaLiga', 54: 'LaLiga2',
  23: 'Serie A', 24: 'Serie B',
  35: 'Bundesliga', 44: 'Bundesliga 2',
  34: 'Ligue 1', 182: 'Ligue 2',
  238: 'Primeira Liga', 239: 'Liga Portugal 2',
  // Europe secondaire
  37: 'Eredivisie', 57: 'Eerste Divisie',
  1: 'Pro League', // Belgique
  52: 'Super Lig', // Turquie
  230: 'Süper Lig',
  244: 'Scottish Premiership',
  329: 'League of Ireland',
  42: 'Ekstraklasa', // Pologne
  47: 'Superliga', // Roumanie
  270: 'First Professional Football League', // Bulgarie
  197: 'Super League', // Grèce
  196: 'Hungarian OTP Bank Liga',
  208: 'Czech First League',
  236: 'Slovak Super Liga',
  218: 'Ukrainian Premier League',
  215: 'Swiss Super League',
  116: 'Austrian Football Bundesliga',
  263: 'HNL', // Croatie
  332: 'Premier Liga', // Bosnie
  228: 'A Lyga', // Lituanie
  304: 'SFL', // Lettonie
  316: 'Meistriliiga', // Estonie
  244: 'Veikkausliiga', // Finlande
  456: 'Allsvenskan', // Suède
  341: 'Superligaen', // Danemark
  242: 'Eliteserien', // Norvège
  227: 'Erovnuli Liga', // Géorgie
  80: 'Slovenian PrvaLiga',
  63: 'Serbian SuperLiga',
  // Amériques
  128: 'Major League Soccer',
  262: 'Liga MX',
  11: 'Brasileirao',
  155: 'Primera Division', // Argentine
  335: 'Primera Division', // Chili
  238: 'Categoria Primera A', // Colombie
  340: 'Serie A', // Equateur
  // Asie & Afrique
  307: 'Saudi Pro League',
  98: 'J1 League', // Japon
  292: 'K League 1', // Corée
  169: 'Chinese Super League',
  305: 'Botola Pro', // Maroc
  673: 'DStv Premiership', // Afrique du Sud
  ...
  929: 'UEFA Conference League',
  6: 'FIFA World Cup',
  1: 'World Cup'
};

// IDs des tournois autorisés (uniquement ces IDs passeront)
var ALLOWED_IDS = [
  // Top 5 européen + Portugal
  17, 18, 8, 54, 23, 24, 35, 44, 34, 182, 238, 239,
  // Europe secondaire niveau 1
  37, 1, 52, 230, 244, 329, 42, 47, 270, 197, 196, 208, 63, 236, 218, 215, 116, 263, 332, 228, 304, 316, 456, 341, 242, 227, 80,
  // Compétitions européennes
  7, 3, 848, 929, 679,
  // Monde
  128, 262, 11, 155, 335, 238, 340, 307, 98, 292, 169, 305, 673,
  // Coupe du monde
  6, 4, 5
];
...
function isTopLevel(e) {
  // Vérifier si le tournoi est dans notre liste autorisée
  if (e.tournament && e.tournament.uniqueTournament) {
    var uid = e.tournament.uniqueTournament.id;
    if (ALLOWED_IDS.indexOf(uid) !== -1) return true;
  }
  if (e.tournament) {
    var tid = e.tournament.id;
    if (ALLOWED_IDS.indexOf(tid) !== -1) return true;
  }
  // Fallback: top-competitions uniquement
  if (!e.eventFilters || !e.eventFilters.level) return false;
  var levels = e.eventFilters.level;
  return levels.indexOf('top-competitions') !== -1;
}
