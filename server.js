...
app.post('/api/analyze', function(req, res) {
  ...
  var prompts = {
    ...
    compo: 'Analyste football. ' + m.home + ' vs ' + m.away + ' (' + m.leagueName + ') le ' + m.date + '. Donne: formation probable et style de jeu de chaque equipe, enjeux du match, analyse tactique, score predit avec % confiance. ' + L,
