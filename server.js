...
// ── FILTRE DES TOURNOIS ───────────────────────────────────────────────────
// Approche par nom de tournoi + slug (plus fiable que les IDs)

// Division 1 - tous ces pays
var D1_SLUGS = [
  // Top 5 + Portugal
  'premier-league', 'laliga', 'serie-a', 'bundesliga', 'ligue-1', 'primeira-liga',
  // Europe
  'eredivisie', 'pro-league', 'jupiler-pro-league', // Belgique
  'super-lig', 'superlig', // Turquie
  'scottish-premiership', 'premiership', // Ecosse
  'league-of-ireland', 'ssp', // Irlande
  'ekstraklasa', // Pologne
  'superliga', 'liga-1', // Roumanie
  'first-professional-football-league', 'parva-liga', // Bulgarie
  'super-league', 'superleague', // Grèce
  'otp-bank-liga', 'nb-i', // Hongrie
  'fortuna-liga', 'czech-first-league', // Tchéquie
  'super-liga', 'serbian-super-liga', // Serbie
  'fortuna-liga-slovakia', 'slovak-super-liga', // Slovaquie
  'premier-liga', 'ukrainian-premier-league', // Ukraine
  'super-league-1', 'swiss-super-league', // Suisse
  'bundesliga-austria', 'admiral-bundesliga', // Autriche
  'hnl', 'hrvatska-nogometna-liga', // Croatie
  'premier-liga-bih', 'premijer-liga', // Bosnie
  'a-lyga', // Lituanie
  'virsliga', 'latvian-higher-league', // Lettonie
  'meistriliiga', // Estonie
  'veikkausliiga', // Finlande
  'allsvenskan', // Suède
  'superligaen', // Danemark
  'eliteserien', // Norvège
  'erovnuli-liga', 'georgian-erovnuli-liga', // Géorgie
  'prva-liga', 'slovenian-prva-liga', // Slovénie
  // Monde
  'mls', 'major-league-soccer', // USA
  'liga-mx', 'liga-bbva-mx', // Mexique
  'brasileirao', 'serie-a-brazil', 'brasileiro', // Brésil
  'primera-division', 'liga-profesional', // Argentine
  'primera-b', 'campeonato', // Chili
  'categoria-primera-a', 'liga-betplay', // Colombie
  'serie-a-ecuador', 'liga-pro', // Équateur
  'saudi-pro-league', 'roshn-saudi-league', // Arabie Saoudite
  'j1-league', 'meiji-yasuda-j1', // Japon
  'k-league-1', // Corée
  'chinese-super-league', 'csl', // Chine
  'botola-pro', 'inwi-botola', // Maroc
  'dstv-premiership', 'psl', // Afrique du Sud
];

// Division 2 - seulement top 6
var D2_SLUGS = [
  'championship', // Angleterre D2
  'laliga2', 'segunda-division', // Espagne D2
  'serie-b', // Italie D2
  '2-bundesliga', 'bundesliga-2', '2bundesliga', // Allemagne D2
  'ligue-2', // France D2
  'liga-portugal-2', 'ligapro', 'segunda-liga', // Portugal D2
];

// Coupes nationales - top 7
var CUP_SLUGS = [
  'fa-cup', // Angleterre
  ...
  'taca-de-portugal', 'taca-portugal', // Portugal
  'coupe-de-belgique', 'beker-van-belgie', // Belgique
];

// Compétitions européennes et mondiales
var EURO_SLUGS = [
...
function isAllowedTournament(e) {
  ...
  var slug = e.tournament.slug ? e.tournament.slug.toLowerCase() : '';
  var name = e.tournament.name ? e.tournament.name.toLowerCase() : '';
  var uslug = '';
  var uname = '';
  if (e.tournament.uniqueTournament) {
    uslug = e.tournament.uniqueTournament.slug ? e.tournament.uniqueTournament.slug.toLowerCase() : '';
    uname = e.tournament.uniqueTournament.name ? e.tournament.uniqueTournament.name.toLowerCase() : '';
  }
  
  var allSlugs = [slug, uslug];
  var allNames = [name, uname];
  
  function matchesAny(list) {
    return list.some(function(item) {
      return allSlugs.some(function(s){ return s.indexOf(item) !== -1 || item.indexOf(s) !== -1; }) ||
             allNames.some(function(n){ return n.indexOf(item) !== -1 || item.indexOf(n) !== -1; });
    });
  }
  
  return matchesAny(D1_SLUGS) || matchesAny(D2_SLUGS) || matchesAny(CUP_SLUGS) || matchesAny(EURO_SLUGS);
}
